    ...
    <section className="relative min-h-screen flex items-center justify-center bg-transparent">
      ...
      >
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          ...
          {/* PRIMARY BUTTON */}
          <button className="px-8 py-3 rounded-full bg-linear-to-r from-[#8b5cf6] to-[#5b21b6] text-white font-semibold 
          ...
          {/* SECONDARY BUTTON */}
          <button className="px-8 py-3 rounded-full border border-[rgba(124,58,237,0.3)] text-white 
